...
//        backgroundColor = .green
    ...
    override func draw(_ rect: CGRect) {
        ...
        foregroundLayer = createCircularLayer(rect: rect, radius: radius, strokeColor: UIColor.red.cgColor, fillColor: UIColor.clear.cgColor, lineWidth: 4, strokeEnd: 0)
